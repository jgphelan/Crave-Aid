...
public class UtilsIngredients {
  ...
  /**
   * Converts a 2D array of Strings to a JSON string using Moshi, is not
   * used in the final implementation but is useful for testing as well as
   * if a additional user wishes to use this function in a different front end
   * that requires a general 2D array of Strings as oppsed to a list of Recipe objects
   *
   ...
   * This function is used to get the recipe data from the API
  ...
  /**
   * Parses the recipe data from the 2D array of Strings to a JSON string that 
   * can be sent to the front end and easily deserialized
   *
   * @param recipesData The 2D array of Strings to parse, for this 
   * implementation rows are recipes and columns are attributes of the recipe
   * @return The JSON string representation of the recipe data
   * for this implementation the JSON string is a list of Recipe objects
   */
